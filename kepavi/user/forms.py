...
is_image = regexp(IMG_RE, message="Only jpg, jpeg, png and gifs are allowed!")


class CreateFBAAnalysisForm(Form):
    title = StringField('title', validators=[DataRequired(message='An analysis title is mandatory')])
    model = SelectField('Choose a model', validators=[DataRequired(message='a model is required')])
    reactions = SelectField('objective function', choices=[('', '')], validators=[DataRequired(message='objective function are required')])
...
class CreateProjectForm(Form):
    ...
    title = StringField('title', validators=[DataRequired(message='A project title is mandatory')])
